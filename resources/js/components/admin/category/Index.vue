    ...
    <div class="container">
        ...
        <table v-if="model" class="table table-striped">
            ...
            <tr>
                ...
                <th scope="col">
                    <router-link :to="{name: 'admin.category.edit', params: {id: 'create'}}">
            ...
            <tr v-for="item in model.data">
                ...
                <td>{{item.title}}</td>
                <td>
                    <router-link :to="{name: 'admin.category.edit', params: {id: item.id}}">
                    ...
                    <i @click="del('/api/admin/category/'+item.id)">
